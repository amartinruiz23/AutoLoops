...
async function loadFile() {
  ...
  //Promise.all(promises).then((samples) => initialMelody = actualMelody = samples[0]);
...
function setMelody(mel) {
  let chunks = [];
  quantizedMel = mm.sequences.quantizeNoteSequence(actualMelody, 4)
